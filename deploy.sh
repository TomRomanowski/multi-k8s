...
# Update images
kubectl set image deployments/client-deployment server=tomromanowski7/multi-client:"$SHA"
kubectl set image deployments/server-deployment server=tomromanowski7/multi-server:"$SHA"
kubectl set image deployments/worker-deployment server=tomromanowski7/multi-worker:"$SHA"
